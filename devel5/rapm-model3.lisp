...
;; Model 3: Modifies the way solutions are found.
(define-model bar-devel5-model3
...
(chunk-type missing-cell kind nature pid match response) 
...
;(spp-fct `((check*solution-found-and-continue :reward ,*negative-reward*)))
;(spp-fct `((check*solution-found-and-give-up :reward ,*negative-reward*)))
(spp-fct `((check*solution-found :reward ,*negative-reward*)))
