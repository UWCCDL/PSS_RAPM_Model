...
(general-simulations 200 :fname "simulations-devel4-newchoice-newprobs-newbold-tick-30-upper-4.0-difficulty-1.txt" :tickvals '(30) :upprbndvals '(4.0) :difficulty '(1))
(quit)
