...
(general-simulations 200 :fname "simulations-devel4-newchoice-newprobs-newbold-tick-35-upper-2.0-difficulty-2.txt" :tickvals '(35) :upprbndvals '(2.0) :difficulty '(2))
(quit)
