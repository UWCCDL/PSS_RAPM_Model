...
(general-simulations 200 :fname "simulations-devel4-newchoice-newprobs-newbold-tick-30-upper-2.0-difficulty-1.txt" :tickvals '(30) :upprbndvals '(2.0) :difficulty '(1))
(quit)
