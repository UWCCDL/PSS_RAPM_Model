...
(general-simulations 200 :fname "simulations-devel4-newchoice-newprobs-newbold-tick-22-upper-1.0-difficulty-1.txt" :tickvals '(22) :upprbndvals '(1.0) :difficulty '(1))
(quit)
