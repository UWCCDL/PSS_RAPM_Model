...
(general-simulations 200 :fname "simulations-devel4-newchoice-newprobs-newbold-tick-22-upper-2.0-difficulty-2.txt" :tickvals '(22) :upprbndvals '(2.0) :difficulty '(2))
(quit)
