...
(general-simulations 200 :fname "simulations-devel4-newchoice-newprobs-newbold-tick-25-upper-2.0-difficulty-1.txt" :tickvals '(25) :upprbndvals '(2.0) :difficulty '(1))
(quit)
