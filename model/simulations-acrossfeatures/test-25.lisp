...
(general-simulations 200 :fname "simulations-devel4-newchoice-newprobs-newbold-tick-20-upper-3.0-difficulty-1.txt" :tickvals '(20) :upprbndvals '(3.0) :difficulty '(1))
(quit)
