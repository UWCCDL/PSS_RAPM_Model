...
(general-simulations 200 :fname "simulations-devel4-newchoice-newprobs-newbold-tick-22-upper-3.0-difficulty-1.txt" :tickvals '(22) :upprbndvals '(3.0) :difficulty '(1))
(quit)
