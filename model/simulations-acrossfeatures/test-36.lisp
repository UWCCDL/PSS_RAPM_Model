...
(general-simulations 200 :fname "simulations-devel4-newchoice-newprobs-newbold-tick-25-upper-3.0-difficulty-2.txt" :tickvals '(25) :upprbndvals '(3.0) :difficulty '(2))
(quit)
