...
(general-simulations 200 :fname "simulations-devel4-newchoice-newprobs-newbold-tick-35-upper-3.0-difficulty1.txt" :tickvals '(35) :upprbndvals '(3.0) :difficulty '(1))
(quit)
